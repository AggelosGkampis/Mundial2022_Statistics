...
namespace DAL.Initializers
{
    internal class MockUpDbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            Player p18 = new Player() { Name = "Éder Militão", Position = Position.CB, BirthDate = new DateTime(1998, 01, 18), IsCaptain = false, ImageUrl = "https://img.a.transfermarkt.technology/portrait/header/401530-1568189259.jpg?lm=1" };
            Player p19 = new Player() { Name = "Bruno Guimarães", Position = Position.DM, BirthDate = new DateTime(1997, 11, 16), IsCaptain = false, ImageUrl = "https://img.a.transfermarkt.technology/portrait/header/520624-1668522672.jpg?lm=1" };
